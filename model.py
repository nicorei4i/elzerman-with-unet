...
class UNet(nn.Module):
    def __init__(self, n_class):
        ...
        # Encoder
        # In the encoder, convolutional layers with the Conv1d function are used to extract features from the input image. 
        # Each block in the encoder consists of two convolutional layers followed by a max-pooling layer, with the exception of the last block which does not include a max-pooling layer.
        # -------
        self.e11 = nn.Conv1d(1, 64, kernel_size=3, padding=1) 
        ...
        self.e41 = nn.Conv1d(256, 512, kernel_size=3, padding=1) 
        self.e42 = nn.Conv1d(512, 512, kernel_size=3, padding=1) 
        self.pool4 = nn.MaxPool1d(kernel_size=2, stride=2) 

        self.e51 = nn.Conv1d(512, 1024, kernel_size=3, padding=1) 
        self.e52 = nn.Conv1d(1024, 1024, kernel_size=3, padding=1) 
