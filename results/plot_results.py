...
def plot_comparison(file_name_unet, file_name_aenc, title='Performance comparison of the models'):
...
plot_comparison(file_name_unet, file_name_aenc, r'$\Gamma_{in} = 3500$ Hz, $\Gamma_{out} = 4200$ Hz')
